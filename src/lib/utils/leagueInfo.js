/*   STEP 1   */
export const leagueID = "650797120235855872"; // your league ID
export const leagueName = "LiveNasty DyNasty"; // your league name
...
export const homepageText = `
  <p>Winning is easy. Just have all the #1 players. Trades are for chumps.</p>
`;
